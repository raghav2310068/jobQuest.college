...
// const loginPassword = document.getElementById("loginPass").textContent;

// const checkCred = function () {
//   console.log(username);
//   console.log(designationVal);
//   console.log(loginID);
//   console.log(loginPassword);
// };
// document.getElementById("loginBtn").addEventListener("click", checkCred());
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const checkCred = function () {
    ...
    console.log("Designation:", designationVal);
    console.log("Login ID:", loginID);
    console.log("Password:", loginPassword);

    // You can add further validation and authentication logic here
  };
